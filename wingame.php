...
// Gera uma nova chave sempre que esta página é acessada
$key = genKey(4);
...
if ($resultado_verifica) {
    ...
    if ($row['total'] == 0) {
        ...
        // Se a chave já existe no banco de dados, você pode decidir o que fazer aqui
        // Poderia ser uma mensagem ou um redirecionamento, dependendo da lógica do seu jogo
    }
} else {
...
<body>
    <div class="container">
        <h1 class="mb-4">Código Gerado</h1>
        <p id="codigoGerado" class="lead"><?php echo $key; ?></p> <!-- Exibe o código gerado -->
